...
public class sendtouser extends AppCompatActivity {
    ...
    private void showData(String phonenumber) {
        ...
        Cursor cursor = new com.chirag.apnabank.DatabaseHelper(this).readselectuserdata(phonenumber);
    ...
    public void selectuser(int position) {
       selectuser_phonenumber = modelList_sendtouser.get(position).getPhoneno();
        Cursor cursor = new com.chirag.apnabank.DatabaseHelper(this).readparticulardata(selectuser_phonenumber);
        while(cursor.moveToNext()) {
            ...
            new com.chirag.apnabank.DatabaseHelper(this).insertTransferData(date, name, selectuser_name, transferamount, "Success");
            new com.chirag.apnabank.DatabaseHelper(this).updateAmount(selectuser_phonenumber, Dselectuser_remainingamount.toString());
            calculateAmount();
            Toast.makeText(this, "Transaction Successful!", Toast.LENGTH_LONG).show();
            startActivity(new Intent(sendtouser.this, com.chirag.apnabank.user_list.class));
            finish();
        }
    }
    ...
    private void calculateAmount() {
        ...
        new com.chirag.apnabank.DatabaseHelper(this).updateAmount(phonenumber, remainingamount);
    }
        ...
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        new com.chirag.apnabank.DatabaseHelper(sendtouser.this).insertTransferData(date, name, "Not selected", transferamount, "Failed");
