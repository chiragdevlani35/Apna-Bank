...
public class user_data extends AppCompatActivity {
    ...
    private void showData(String phonenumber) {
        Cursor cursor = new com.chirag.apnabank.DatabaseHelper(this).readparticulardata(phonenumber);
        ...
        builder_exitbutton.setTitle("Do you want to cancel the transaction?").setCancelable(false)
                .setPositiveButton("yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        new com.chirag.apnabank.DatabaseHelper(user_data.this).insertTransferData(date, name.getText().toString(), "Not selected", "0", "Failed");
